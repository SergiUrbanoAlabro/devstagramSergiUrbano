...
<head>
    ...
    <title>DevStagram - @yield('titol')</title>
    ...
    <header class="p-5 bg-white shadow">
        <div class="w-11/12 mx-auto flex justify-between items-center">
            ...
            <nav class="flex gap-2">
                ...
                <a class="font-bold uppercase text-gray-600 text-sm" href="{{ route('register') }}">Crear compte</a>
            </nav>
            @endguest
        </div>
    </header>

    <main class="w-11/12 mx-auto mt-10">
        <h2 class="font-black text-center text-3xl mb-10">@yield('titol')</h2>
        @yield('contingut')
    </main>

    <footer class="mt-10 text-center p-5 text-gray-500 font-bold uppercase">
        DevStagram - Tots els drets Reservats &copy; {{ now()->year }}
    </footer>
    @livewireScripts
</body>
